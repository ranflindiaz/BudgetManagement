...
namespace BudgetManagement.Services
{
    public class UserStore : IUserStore<User>, IUserEmailStore<User>, IUserPasswordStore<User>
    {
        ...
        public UserStore(IUsersRepository userRepository)
        {
        ...
        {
            user.Id = await _userRepository.UserCreate(user);
        ...
        {
            return await _userRepository.FindUserByEmail(normalizedUserName);
